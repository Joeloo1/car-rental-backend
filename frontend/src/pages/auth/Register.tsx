  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden font-sans">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="flex w-full max-w-[1020px] min-h-[680px] rounded-3xl overflow-hidden border border-border bg-card/20 backdrop-blur-2xl shadow-xl"
      >
        ...
        <div className="flex-1 bg-background/40 p-8 md:p-12 flex items-center justify-center overflow-y-auto">
          <div className="w-full max-w-md space-y-6">
            <motion.div variants={itemVariants} className="space-y-2 text-center lg:text-left">
              <h2 className="text-3xl font-display font-bold tracking-tight text-foreground">Create Account</h2>
              <p className="text-muted-foreground text-sm">Join LuxeDrive and start your journey</p>
            </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex flex-col gap-1 pt-1">
                <label className="flex items-center gap-2.5 text-muted-foreground cursor-pointer select-none group">
                  <input 
                    type="checkbox" 
                    className={cn(
                      "appearance-none w-5 h-5 bg-card border border-border rounded checked:bg-primary checked:border-primary cursor-pointer transition-all",
                      errors.agree && "border-destructive"
                    )}
                    {...register("agree")}
                    disabled={isSubmitting}
                  />
                  <span className="text-sm">I agree to the <Link to="/terms" className="text-primary hover:underline font-medium transition-colors">Terms of Service</Link></span>
                </label>
                {errors.agree && (
                  <p className="text-xs font-medium text-destructive">{errors.agree.message}</p>
                )}
              </motion.div>
            ...
            <motion.div variants={itemVariants} className="relative flex py-1 items-center">
              ...
              <span className="flex-shrink mx-4 text-muted-foreground text-xs uppercase tracking-widest font-semibold">Or sign up with</span>
              <div className="flex-grow border-t border-border"></div>
            </motion.div>
