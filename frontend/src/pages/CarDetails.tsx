...
const CarDetails: React.FC = () => {
  ...
  if (error || !car) {
    return (
      <div className="min-h-screen bg-[#080808] pt-24 flex items-center justify-center">
  ...
  return (
    <>
      <div className="min-h-screen bg-[#080808] text-ink-primary font-sans pt-24 pb-20 relative overflow-hidden">
        {/* Ambient glows */}
        <div className="fixed top-0 right-0 w-[40%] h-[40%] bg-blue/[0.04] blur-[120px] rounded-full pointer-events-none" />
        <div className="fixed bottom-0 left-0 w-[30%] h-[30%] bg-purple-600/[0.04] blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex items-center gap-1 text-amber bg-amber/[0.08] px-2 py-1 rounded-lg border border-amber/15">
                  <Star size={14} fill="currentColor" />
                  <span className="text-sm font-bold">
                    {car.averageRating || "5.0"}
                  </span>
                  <span className="text-ink-tertiary text-xs font-medium ml-1">
              ...
              <h1 className="text-5xl md:text-7xl font-display font-bold tracking-tight leading-none mb-4">
                {car.brand}{" "}
                <span className="text-blue">{car.model}</span>
              </h1>
                ...
                {[1, 2].map(idx => (
                  <div
                    ...
                    className={cn(
                      ...
                      activeImage === idx ? "ring-2 ring-blue" : "ring-1 ring-white/[0.06]"
                    )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 items-start">
            ...
            >
              ...
              <section>
                <h2 className="text-2xl font-display font-bold mb-8 flex items-center gap-3">
                  <span className="w-1.5 h-6 bg-blue rounded-full" />
                  Performance Specs
                </h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {specs.map((spec, i) => (
                    <div
                      key={i}
                      className="p-6 rounded-2xl bg-surface-1 border border-[#1c1c1c] hover:border-[#282828] flex flex-col items-center gap-4 text-center transition-colors"
                    >
                      <div className="w-12 h-12 rounded-2xl bg-blue/10 border border-blue/20 flex items-center justify-center">
                        <spec.icon size={22} className="text-blue" />
                      </div>
                      <div>
              ...
              {/* Host */}
              <section>
                <div className="p-8 rounded-2xl bg-surface-1 border border-[#1c1c1c] flex flex-col md:flex-row items-center gap-8">
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    <div className="absolute -bottom-1 -right-1 bg-blue text-white p-1.5 rounded-full border-2 border-[#080808]">
                      <Shield size={11} />
                    </div>
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <p className="text-xs font-bold text-blue uppercase tracking-widest mb-1">Vehicle Host</p>
            ...
            >
              <div className="rounded-[28px] bg-surface-1 border border-[#1c1c1c] shadow-xl overflow-hidden">
                <div className="p-8">
                  {/* Price header */}
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Calendar
                          className="absolute left-4 top-1/2 -translate-y-1/2 text-blue pointer-events-none"
                          size={15}
                        />
                        <input
                          type="date"
                          ...
                          className="w-full bg-surface-2 border border-[#2a2a2a] rounded-xl pl-11 pr-4 py-3.5 text-sm font-medium text-ink-primary focus:ring-1 focus:ring-blue/30 focus:border-blue transition-all outline-none"
                        />
                      </div>
                    </div>
                    <div className="space-y-1.5">
                  ...
                  {/* Price breakdown */}
                  {calculateDays() > 0 && (
                    <div className="bg-surface-2 rounded-2xl p-5 space-y-3 mb-8 border border-[#282828]">
                      ...
                      <div className="flex justify-between text-sm">
                        <span className="text-ink-tertiary">Insurance &amp; Service</span>
                        <span className="font-semibold">${serviceFee}</span>
                      </div>
                      <div className="pt-3 border-t border-[#2a2a2a] flex justify-between items-center">
                        <span className="font-display font-bold">Total</span>
                        <span className="text-2xl font-display font-bold text-blue">${calculateTotal()}</span>
                      </div>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className="w-full h-13 py-4 rounded-2xl font-display font-bold text-base text-black shadow-lg shadow-blue/20 disabled:opacity-60 transition-opacity hover:opacity-90 active:scale-[0.99] flex items-center justify-center gap-2"
